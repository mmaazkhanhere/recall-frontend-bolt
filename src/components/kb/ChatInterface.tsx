    ...
    <>
      <div className="flex h-96 flex-col overflow-hidden rounded-lg border bg-card">
        ...
        <div className="border-b bg-muted/50 px-4 py-2">
          <h3 className="text-sm font-medium text-card-foreground">AI Assistant</h3>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          <AnimatePresence>
            {messages.map((message) => (
              ...
              >
                <div className={`flex max-w-[80%] space-x-2 ${message.type === 'user' ? 'flex-row-reverse space-x-reverse' : ''}`}>
                  {/* Avatar */}
                  ...
                  <div className="flex flex-col space-y-2">
                    <div className={`rounded-lg px-3 py-2 ${
                      ...
                      {/* Timestamp Link */}
                      {message.videoTimestamp !== undefined && onTimestampClick && (
                        <motion.button
